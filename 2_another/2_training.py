...
# 2. Load dataset
train_data = pd.read_excel("./2_another/output/5_train_data.xlsx")  # Data latih
test_data = pd.read_excel("./2_another/output/5_test_data.xlsx")    # Data uji
...
predictions.to_excel("./2_another/output/5_predictions.xlsx", index=False)
print("\nPrediksi disimpan ke '5_predictions.xlsx'.")
